    ...
    <div className='pb-5 pt-2 bg-gradient-to-b from-red-600 to-orange-500 text-white'>
      <div className='container mx-auto '>
        <div className='flex justify-end items-center space-x-6'>
          {/* Gọi component Popover */}
          <Popover
            className='flex items-center py-1 hover:text-white/70 cursor-pointer '
            renderPopover={
              <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                <div className='flex flex-col py-2 pr-28 pl-3'>
                  <button className='py-2 px-3 hover:text-orange-500 cursor-pointer'>Tiếng Việt</button>
                  <button className='py-2 px-3 hover:text-orange-500 mt-2 cursor-pointer'>Tiếng Anh</button>
                </div>
              </div>
            }
          >
          ...
          {isAuthenticated && (
            // đã isAuthenticated thì show popover
            <Popover
              className='ml-6 flex items-center py-1 hover:text-white/70 cursor-pointer'
              renderPopover={
                <div>
                  <Link
                    to='/profile'
                    className='text-left w-full block py-3 px-4 hover:bg-slate-100 bg-white hover:text-cyan-500'
                  >
                    Tài khoản của tôi
                  </Link>
                  <Link
                  ...
                  <button
                    ...
                    className='cursor-pointer text-left w-full block py-3 px-4 hover:bg-slate-100 bg-white hover:text-cyan-500'
                  >
                    Đăng xuất
                  </button>
                </div>
          ...
          {!isAuthenticated && (
            // Nếu chưa đăng nhập thì show 2 đường link
